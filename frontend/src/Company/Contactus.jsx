...
const Contactus = () => {
  ...
  return (
    <>
          ...
          <div className="aboutUs-container flex w-80 h-auto min-h-400 flex-col p-20 gap-50">
            <div className="flex w-full h-auto flex-col gap-20">
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                can. Please feel free to reach out to us via the following
                channels:
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                dedicated customer support team is available 24/7. You can
                contact us at modaZen@support.com or call us at +1234567890
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
            ...
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                We welcome your feedback and suggestions to improve your
                experience with ModaZen. Share your thoughts with us at
                modaZen@support.com
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                Mumbai
                <p className="font-poppins text-dark-grey text-18 font-500">
                  We Work Spectrum, 307, Chincholi Bunder Road, Malad, Rajan
                  Pada, Mindspace, Malad West, Mumbai, Maharashtra 400064.
                </p>
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                Stay connected and updated with ModaZen by following us on
                social media: <br></br>
                <br></br>
      ...
      {isMobile && (
        <div className="aboutUs flex justify-center items-center w-full h-auto flex-col mb-100 bg-dark-white gap-20 mt-70">
          <div className="aboutUs-title flex justify-center items-center w-80 h-full">
            <span className="font-poppins text-main-color text-22 font-700 tracking-1">
              ModaZen/Contact
            </span>
          </div>
          <div className="aboutUs-container flex w-90 h-auto min-h-400 flex-col p-10 gap-20">
