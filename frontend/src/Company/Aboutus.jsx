          ...
          <div className="flex w-80 h-auto min-h-400 flex-col p-20 gap-50">
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                enriching shopping journey, ensuring you find everything you
                need to express your unique style effortlessly.
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
              <span className="font-poppins text-main-color text-22 font-700 tracking-1">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                fashion. We believe that clothing is not just about covering
                your body but expressing your personality, aspirations, and
                creativity. Our platform is designed to empower you to embrace
                fashion as an extension of yourself, celebrating diversity,
            ...
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                Explore a vast and diverse collection of apparel, accessories,
                and footwear from renowned Indian and international brands. From
                timeless classics to the latest trends, we offer something for
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                Shop with confidence knowing that every product on ModaZen is
                100% authentic, ensuring you receive top-quality items that meet
                your expectations.
              </p>
              <p className="font-poppins text-dark-grey text-18 font-500">
                <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
                ...
                Experience hassle-free shopping with our user-friendly
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                exclusive collections curated by our team of experts. Discover
                new ways to elevate your wardrobe and express your unique style
                effortlessly.
              </p>
            </div>
            <div className="flex w-full h-auto flex-col gap-20">
              ...
              <p className="font-poppins text-dark-grey text-18 font-500">
                ...
                statement pieces, or special occasion attire, we strive to be
                your trusted partner in enhancing your style journey. Join us in
                embracing the beauty of fashion and expressing your authentic
        ...
        <div className="flex justify-center items-center w-full h-auto flex-col mb-100 bg-dark-white gap-20 mt-70">
          ...
          <div className="flex w-90 h-auto min-h-400 flex-col p-10 gap-30">
            ...
            <div className="flex w-full h-auto flex-col gap-10">
              ...
              <p className="font-poppins text-dark-grey text-14 font-500">
                <h3 className="font-poppins text-main-color text-14 font-600 mb-10 mt-10">
                  1. Unrivaled Selection:
                </h3>{" "}
                Explore a vast and diverse collection of apparel, accessories,
                and footwear from renowned Indian and international brands. From
