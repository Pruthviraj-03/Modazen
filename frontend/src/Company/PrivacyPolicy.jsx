      ...
      <div className="flex w-80 h-auto min-h-400 flex-col p-20 gap-50">
        <div className="flex w-full h-auto flex-col gap-20">
          <p className="font-poppins text-dark-grey text-18 font-500">
            At ModaZen, we are committed to protecting your privacy and ensuring
        ...
        <div className="flex w-full h-auto flex-col gap-20">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            including your browsing history, IP address, device information, and
            cookies.
          </p>
          <p className="font-poppins text-dark-grey text-18 font-500">
            <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
            ...
            If you contact us via email, phone, or other communication channels,
            we may retain records of your correspondence for customer support
        ...
        <div className="flex w-full h-auto flex-col gap-20">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            products, and provide customer support related to your purchases.
          </p>
          <p className="font-poppins text-dark-grey text-18 font-500">
            <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
            ...
            personalize your experience, and communicate important updates and
            promotions.
          </p>
          <p className="font-poppins text-dark-grey text-18 font-500">
            <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            regulation, or legal process, or to protect our rights, property, or
        ...
        <div className="flex w-full h-auto flex-col gap-20">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            notify you via email or prominent notice on our website if such a
            change occurs.
          </p>
          <p className="font-poppins text-dark-grey text-18 font-500">
            <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
        ...
        <div className="flex w-full h-auto flex-col gap-20">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            unauthorized access, use, or disclosure. Our website is secured with
            SSL encryption, and we implement industry-standard security
        ...
        <div className="flex w-full h-auto flex-col gap-20">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            You can review and update your account information, communication
            preferences, and marketing subscriptions by logging into your
            ModaZen account.
          </p>
          <p className="font-poppins text-dark-grey text-18 font-500">
            <h3 className="font-poppins text-main-color text-18 font-600 mb-15">
          ...
          <p className="font-poppins text-dark-grey text-18 font-500">
            ...
            Upon request, we will provide access to your personal information
            and allow you to update or delete it, subject to legal and
